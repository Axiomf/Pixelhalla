...
def load_map(level_state):
    ...
    static_platform3 = Platform(680, config.SCENE_HEIGHT*2/5 + 14, 
                            ...
                            color=None)
    if(level_state == 0):
        fighter_animation = load_animations_Goblin(150,150,crop_x= 60,crop_y= 65, crop_width=30, crop_height=35)
