...
def load_map(level_state, fighter1_id, fighter2_id, fighter_select_phase):
    ...
    static_platform3 = Platform(693, config.SCENE_HEIGHT*2/5 - 6, 
                            ...
                            color=(0,0,0))
    powerup = PowerUp(static_platform1.rect.x, config.SCENE_HEIGHT - 30,"double_jump",5, width=30, height=30, color=(255,255,0), image_path="src/assets/images/inused_single_images/double_jump.png", all_sprites=all_sprites, power_ups=power_ups, platforms=platforms)
    powerup2 = PowerUp(static_platform2.rect.x, config.SCENE_HEIGHT - 30,"damage",20, width=30, height=30, color=(150,0,0), image_path="src/assets/images/inused_single_images/damage.png", all_sprites=all_sprites, power_ups=power_ups, platforms=platforms)
    powerup3 = PowerUp(static_platform3.rect.x, config.SCENE_HEIGHT - 30,"shield",20, width=30, height=30, color=(150,0,0), image_path="src/assets/images/inused_single_images/shield.png", all_sprites=all_sprites, power_ups=power_ups, platforms=platforms)
    powerup4 = PowerUp(static_platform4.rect.x, config.SCENE_HEIGHT - 30,"supershot",4, width=30, height=30, color=(75,75,75), image_path="src/assets/images/inused_single_images/supershot.png",all_sprites=all_sprites, power_ups=power_ups, platforms=platforms)
    ...
    if fighter_select_phase == 2:
        ...
        if enemy_type == Melee:
            ...
            all_sprites.add(static_platform1, static_platform2,static_platform3, static_platform4, fighter1, enemy,powerup,powerup2,powerup3,powerup4, enemy2, enemy3)
