...
class FighterSelectState:
    def __init__(self, scene):
        ...
        self.fighter1_preview = pygame.image.load("src/assets/images/inused_single_images/Elf.jpg").convert_alpha()
        self.fighter1_preview = pygame.transform.scale(self.fighter1_preview, (150, 150))
        self.fighter2_preview = pygame.image.load("src/assets/images/inused_single_images/samurai.jpg").convert_alpha()
        self.fighter2_preview = pygame.transform.scale(self.fighter2_preview, (150, 150))
        self.fighter3_preview = pygame.image.load("src/assets/images/inused_single_images/new_knight.jpg").convert_alpha()
        self.fighter3_preview = pygame.transform.scale(self.fighter3_preview, (150, 150))
        self.fighter4_preview = pygame.image.load("src/assets/images/inused_single_images/arcane1.jpg").convert_alpha()
